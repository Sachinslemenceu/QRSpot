...
@Composable
fun BusinessGenerateCard(
    icon: ImageVector,
    menuName: String,
    onGenerateClicked: (String, String, String, String, String, String, String, String) -> Unit,
    animatedVisibilityScope: AnimatedVisibilityScope,
    sharedTransitionScope: SharedTransitionScope,
    modifier: Modifier = Modifier
) {
    var companyName by remember { mutableStateOf("") }
    var industryName by remember { mutableStateOf("") }
...
@Preview
@Composable
private fun BusinessGenerateCardPreview() {
